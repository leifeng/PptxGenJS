...
## Notes
## 3.13.1-beta.4-20250226

- fixed `firstIndent` property for text 

## 3.13.1-beta.3-20250225

- Added `gradient` property for shape 
- Added `radius` property for image
- Added `outline` property for image
